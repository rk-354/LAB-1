...
/* A scripted, realistic streaming answer with inline citation markers [n]. */
const DEMO_ANSWER = {
...
/* Pre-seeded thread shown when chat loads */
const SEED_THREAD = [
  {
    id: "m1", role: "user",
...
Object.assign(window, {
  DEPARTMENTS, CURRENT_USER, CONVERSATIONS, DEMO_ANSWER, SEED_THREAD,
  STATS, COVERAGE, ACTIVITY, RECENT_QUERIES, USERS, DOCUMENTS,
  deptName, deptShort,
});
