/* ============================================================
   RefineIQ — Login page (aurora background + magic link)
   ============================================================ */
...
function Login({ onLogin }) {
  const [email, setEmail] = React.useState("dana.okafor@refineiq.io");
  ...
  return (
    <div style={{ position: "relative", height: "100%", width: "100%", background: "var(--bg-base)",
        ...
        <div className="glass" style={{
          ...
          {!sent ? (
            <>
              ...
              <button className="focusable" onClick={submit} disabled={!valid} style={{
              ...
              onMouseEnter={e => { if (valid) e.currentTarget.style.boxShadow = "0 10px 34px -6px rgba(139,92,246,0.85)"; }}
              onMouseLeave={e => { if (valid) e.currentTarget.style.boxShadow = "0 8px 26px -8px rgba(124,109,245,0.7)"; }}>
            ...
            <div className="fade-in" style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: 18, padding: "8px 0 4px" }}>
              ...
              <div style={{ display: "flex", gap: 5 }}>
                {[0,1,2].map(i => (
                  <span key={i} style={{ width: 8, height: 8, borderRadius: "50%", background: "var(--violet)",
          ...
          <div style={{ display: "flex", gap: 10 }}>
            {["Okta", "Azure AD"].map(p => (
              ...
              onMouseLeave={e => { e.currentTarget.style.background = "var(--glass-faint)"; e.currentTarget.style.color = "var(--text-2)"; }}>
                {p}
              </button>
            ))}
          </div>
