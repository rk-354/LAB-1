            ...
            <>
              ...
              <button onClick={toggle} title={theme === 'dark' ? 'Switch to light mode' : 'Switch to dark mode'}
                style={{
                  ...
                  background: 'var(--glass-faint)', color: 'var(--text-3)',
                  display: 'grid', placeItems: 'center', cursor: 'pointer', flex: 'none',
                  transition: 'all var(--dur) var(--ease)',
                }}
                onMouseEnter={e => { (e.currentTarget as HTMLButtonElement).style.borderColor = 'var(--border-ai)'; (e.currentTarget as HTMLButtonElement).style.color = 'var(--text-1)'; }}
