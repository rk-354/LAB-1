...
/* ============================================================
   RefinerIQ — Icon set (minimal stroke SVGs)
   ============================================================ */
...
export const Icon = ({ d, paths, size = 18, sw = 1.6, fill = "none", style, ...rest }: IconProps) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
type IconComponent = (p: Omit<IconProps, 'd' | 'paths'>) => React.ReactElement
